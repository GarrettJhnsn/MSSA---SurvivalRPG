    ...
    class Sound
    {
        ...
        public void PlayMusic(int x)
        {
            ...
            try
            {
                if (x == 0)
                {
                    ...
                    soundPlayer.SoundLocation = @"C:\Users\garre\Desktop\MSSA\SurvivalRPG\MSSA-Week-1---SurvivalRPG\Survival RPG\Music\main_background1_master.wav";
                    soundPlayer.PlayLooping();

                }
                else if (x == 1)
                {
                    soundPlayer.SoundLocation = @"C:\Users\garre\Desktop\MSSA\SurvivalRPG\MSSA-Week-1---SurvivalRPG\Survival RPG\Music\main_combat1_master.wav";
                    soundPlayer.PlayLooping();

                }
                else if (x == 2)
                {
                    soundPlayer.SoundLocation = @"C:\Users\garre\Desktop\MSSA\SurvivalRPG\MSSA-Week-1---SurvivalRPG\Survival RPG\Music\main_theme1_master.wav";
                    soundPlayer.PlayLooping();
                }
            }
            catch (Exception)
        ...
        public void PlaySFX(int x)
        {
            ...
            try
            {
                if (x == 1)
                {
                    sfx.URL = @"C:\Users\garre\Desktop\MSSA\SurvivalRPG\MSSA-Week-1---SurvivalRPG\Survival RPG\sfx\magic_attack2_master.wav";
                    sfx.controls.play();
                }
                else if (x == 2)
                {
                ...
                {
                    sfx.URL = @"C:\Users\garre\Desktop\MSSA\SurvivalRPG\MSSA-Week-1---SurvivalRPG\Survival RPG\sfx\bow_attack1_master.wav";
                    sfx.controls.play();
                }
            }
            catch (Exception)
